...
<head>
    ...
    <!-- favicon -->
    <link rel="icon" href="{{ asset('userset/img/logo.png') }}" type="image/gif" />

    <!-- CSS -->
    <link rel="stylesheet" href="{{ asset('userset/css/main.css') }}">
...
<body>
    ...
    <div class="device-notification">
        <a class="device-notification--logo" href="#0">
            <img src="{{ asset('userset/img/logo.png') }}" alt="Global">
            <p>JKE</p>
        </a>
    </div>
                ...
                <div class="l-wrapper">
                    <header class="header">
                        <a class="header--logo" href="#0">
                            <img src="{{ asset('userset/img/minilogo.png') }}" alt="Global">
                            <p>JKE</p>
                        </a>
                        <button class="header--cta cta">Find a solution</button>
                            ...
                            <div class="intro">
                                <div class="intro--banner">
                                    ...
                                    <video autoplay muted loop style="max-width: 400px; margin-bottom: 5%">
                                        <source src="{{ asset('userset/img/gif.mp4') }}" type="video/mp4">
                                    </video>
                                </div>
                        ...
                        <li class="l-section section">
                            <div class="about">
                                <div class="about--banner">
                                    ...
                                    <img src="{{ asset('userset/img/about-visual.png') }}" alt="About Us">
                                </div>
